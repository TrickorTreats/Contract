...
contract TrickOrTreat is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Trick Or Treat";
  string constant tokenSymbol = "TREAT";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0xE932A20f23d63fC59A3A50EaacaAeB9f5042B636] = _balances[0xE932A20f23d63fC59A3A50EaacaAeB9f5042B636].add(tokensToBurn);

    // Sends 1% to TREATS Pot

    emit Transfer(msg.sender, to, tokensToTransfer);

    emit Transfer(msg.sender, 0xE932A20f23d63fC59A3A50EaacaAeB9f5042B636, tokensToBurn);
    return true;
  }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
   ...
   // Sends 1% to TREATS Pot
    ...
    emit Transfer(from, 0xE932A20f23d63fC59A3A50EaacaAeB9f5042B636, tokensToBurn);
